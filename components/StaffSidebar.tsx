...
const staffMenuItems = [
  ...
  { label: "Results", href: "/staff/results", icon: ClipboardCheck },
  { label: "Subjects", href: "/staff/subjects", icon: BookOpen },
  { label: "Manage Results", href: "/staff/manage", icon: BarChart3 },
  { label: "Settings", href: "/staff/settings", icon: Settings },
];

export function StaffSidebar({ profile }: { profile: any }) {
